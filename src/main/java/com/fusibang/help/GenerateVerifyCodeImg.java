...
public class GenerateVerifyCodeImg {
    public static final String VERIFY_CODES = "23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghjkmnpqrstuvwxyz";
    private static Random random = new Random();

    public GenerateVerifyCodeImg() {
    }

    public static String generateVerifyCode(int verifySize) {
        return generateVerifyCode(verifySize, "23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghjkmnpqrstuvwxyz");
    }
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        int font;
        int chars;
        for(int yawpRate = 0; yawpRate < 50; ++yawpRate) {
