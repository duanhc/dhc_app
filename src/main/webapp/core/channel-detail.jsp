                                                            ...
                                                            <div class="ant-table-body">
                                                                <table class="">
                                                                    ...
                                                                    <tr class="ant-table-row  ant-table-row-level-0" data-row-key="<%=user.get("phone")%>">
                                                                        <td class=""><span class="ant-table-row-indent indent-level-0" style="padding-left: 0px;"></span><%=user.get("id")%>
                                                                        </td>
                                                                        <td class=""><%=user.get("name")%>
                                                                        </td>
                                                                        <td class=""><%=user.get("phone")%>
                                                                        </td>
                                                                        <td class="" style="text-align: center;"><%=user.get("time")%>
                                                                        </td>
                                                                    </tr>
                                                                    <%} %>
                                                    ...
                                                    <ul class="ant-pagination ant-table-pagination" unselectable="unselectable">
                                                        ...
                                                        <c:if test="${thisPage > 3}">
                                                            <c:forEach begin="1" end="3" var="i" step="1">
                                                                <a href="user_view_channel.do?page=${i}&star=${star}&end=${end}&channelId=${channelId}">
                                                                    <li title="${i}" class="ant-pagination-item ant-pagination-item-2" tabindex="0">${i}</li>
                                                                </a>
                                                            </c:forEach>
                                                            ...
                                                            <c:if test="${thisPage == 5}">
                                                                <a href="user_view_channel.do?page=4&star=${star}&end=${end}&channelId=${channelId}">
                                                                    <li title="${4}" class="ant-pagination-item ant-pagination-item-2" tabindex="0">4</li>
                                                                </a>
                                                            </c:if>
                                                            <c:if test="${thisPage >= 6}">
                                                                <a href="user_view_channel.do?page=${thisPage-2}&star=${star}&end=${end}&channelId=${channelId}">
                                                                    <li title="${thisPage-2}" class="ant-pagination-item ant-pagination-item-2" tabindex="0">${thisPage-2}</li>
                                                                </a>
                                                                <a href="user_view_channel.do?page=${thisPage-1}&star=${star}&end=${end}&channelId=${channelId}">
                                                                    <li title="${thisPage-1}" class="ant-pagination-item ant-pagination-item-2" tabindex="0">${thisPage-1}</li>
                                                                </a>
                                                            </c:if>
                                                        </c:if>
                                                        ...
                                                        <c:if test="${thisPage + 3 == pageCount}">
                                                            <a href="user_view_channel.do?page=${pageCount}&star=${star}&end=${end}&channelId=${channelId}">
                                                                <li title="${pageCount}" class="ant-pagination-item ant-pagination-item-2" tabindex="0">${pageCount}</li>
                                                            </a>
                                                        </c:if>
                                                        ...
                                                        <c:if test="${thisPage + 3 < pageCount}">
                                                            ...
                                                            <a href="user_view_channel.do?page=${pageCount-1}&star=${star}&end=${end}&channelId=${channelId}">
                                                                <li title="${pageCount-1}" class="ant-pagination-item ant-pagination-item-2" tabindex="0">${pageCount-1}</li>
                                                            </a>
                                                            <a href="user_view_channel.do?page=${pageCount}&star=${star}&end=${end}&channelId=${channelId}">
                                                                <li title="${pageCount}" class="ant-pagination-item ant-pagination-item-2" tabindex="0">${pageCount}</li>
                                                            </a>
